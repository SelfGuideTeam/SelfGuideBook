...
describe('Module: ArabicParser', function() {
  ...
  it('arabicLetterHasIsolatedForm', function() {
    expect(jsPDF.API.__arabicParser__.arabicLetterHasIsolatedForm("ا")).toEqual(true);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasIsolatedForm("د")).toEqual(true);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasIsolatedForm("ف")).toEqual(true);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasIsolatedForm("a")).toEqual(false);
  });

  it('arabicLetterHasFinalForm', function() {
    expect(jsPDF.API.__arabicParser__.arabicLetterHasFinalForm("ا")).toEqual(true);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasFinalForm("د")).toEqual(true);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasFinalForm("ف")).toEqual(true);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasFinalForm("a")).toEqual(false);
  });

  it('arabicLetterHasInitialForm', function() {
    expect(jsPDF.API.__arabicParser__.arabicLetterHasInitialForm("ا")).toEqual(false);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasInitialForm("د")).toEqual(false);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasInitialForm("ف")).toEqual(true);
    //expect(jsPDF.API.__arabicParser__.arabicLetterHasInitialForm("ٌ")).toEqual(true);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasInitialForm("a")).toEqual(false);
  })
  
  it('arabicLetterHasMedialForm', function() {
    expect(jsPDF.API.__arabicParser__.arabicLetterHasMedialForm("ا")).toEqual(false);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasMedialForm("د")).toEqual(false);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasMedialForm("ف")).toEqual(true);
    //expect(jsPDF.API.__arabicParser__.arabicLetterHasMedialForm("ٌ")).toEqual(false);
    expect(jsPDF.API.__arabicParser__.arabicLetterHasMedialForm("a")).toEqual(false);
  });
  ...
  it('resolveLigatures', function() {
    expect(jsPDF.API.__arabicParser__.resolveLigatures("ﻟﺎ").charCodeAt(0)).toEqual(65275);
    expect(jsPDF.API.__arabicParser__.resolveLigatures("كاﻟﺎ").charCodeAt(2)).toEqual(65275);
  });
