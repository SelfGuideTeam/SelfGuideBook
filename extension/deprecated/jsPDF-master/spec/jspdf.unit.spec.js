...
describe('Core: Unit Tests', () => {
  ...
  it('jsPDF PubSub basic check', () => {
    new (new jsPDF).__private__.PubSub({});
  ...
  it('jsPDF private function roundToPrecision', () => {
    ...
    expect(function () { doc.__private__.roundToPrecision('invalid'); }).toThrow(new Error('Invalid argument passed to jsPDF.roundToPrecision'));
  })
...
break`, 10, 10, { scope: doc });
  ...
  it('jsPDF private function putXRef', () => {
    ...
    expect(writeArray).toEqual(['xref', '0 3', '0000000000 65535 f', '0000000039 00000 n', '0000000058 00000 n']);
  })
