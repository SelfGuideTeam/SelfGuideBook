(function($) {
    ...
    function destroyCrop() {
        ...
        window.voilaChromeOption = false;
    ...
    function createCoords(c) {
        ...
        btns.append(btne);
        btns.append('<a class="edit_btn save" id="imgdownload" href="" download="screenshot-by-voila"><i class="save"></i><div class="name">'+chrome.i18n.getMessage("cropBtnSave")+'</div></a>');
        btns.append(btnc);
...
//        });
        ...
        var btnvoila = $('<button/>', {
            html: '<i class="voila"></i>',
            'id': 'screenshotvoila',
            'class': 'edit_btn voila',
            'title': chrome.i18n.getMessage("cropBtnvoila")
        });
//        btnsdone.append(btncopy);
        btnsdone.append(btnvoila);
...
//        });
        ...
        btnvoila.bind('click', function() {
            chrome.extension.sendMessage({msg: 'sendtovoila', img: $('#imgdownload').attr('href')}, function(response) {
                console.log(response);
            });
            destroyCrop();
        });
