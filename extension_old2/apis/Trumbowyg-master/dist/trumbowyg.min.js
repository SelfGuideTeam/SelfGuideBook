    ...
    function (e, t, n, a) {
        ...
        var i = function (o, r) {
            ...
            i.btnsDef = {
                ...
                i.addBtnDef(e, t)
            }), i.eventNamespace = "trumbowyg-event", i.keys = [], i.tagToButton = {}, i.tagHandlers = [], i.pasteHandlers = [].concat(i.o.pasteHandlers), i.isIE = e.userAgent.indexOf("MSIE") !== -1 || e.appVersion.indexOf("Trident/") !== -1, i.isMac = e.platform.toUpperCase().indexOf("MAC") !== -1, i.init()
        };
        i.prototype = {
            ...
            buildEditor: function () {
                ...
                e.$ed.on("dblclick", "img", e.o.imgDblClickHandler).on("keydown", function (t) {
                    ...
                    if (e.$c.trigger("tbw" + t.type), "blur" === t.type && e.clearButtonPaneStatus(), e.o.autogrowOnEnter) {
            ...
            buildBtn: function (e) {
                ...
                if (r) {
                    ...
                    var d = n + "dropdown",
                        c = {
                            "class": d + "-" + e + " " + d + " " + n + "fixed-top " + (o.dropdownClass || "")
                        };
                    c["data-" + d] = e;
                    var u = a("<div/>", c);
                ...
                e.o.fixedBtnPane && (e.isFixed = !1, a(t).on("scroll." + e.eventNamespace + " resize." + e.eventNamespace, function () {
                    if (o) {
                        ...
                        r - i > 0 && r - i - e.height < 0 ? (e.isFixed || (e.isFixed = !0, s.css({
                            ...
                            width: n ? "100%" : o.width() - 1
                        }), a("." + e.o.prefix + "fixed-top", o).css({
                            position: n ? "fixed" : "absolute",
                            top: n ? l : l + (r - i),
                            zIndex: 15
                        })) : e.isFixed && (e.isFixed = !1, s.removeAttr("style"), e.$box.css({
                            paddingTop: 0
                        }), a("." + e.o.prefix + "fixed-top", o).css({
                            position: "absolute",
                            top: l
            ...
            toggle: function () {
                var e = this,
                    t = e.o.prefix;
                e.o.autogrowOnEnter && (e.autogrowOnEnterDontClose = !e.$box.hasClass(t + "editor-hidden")), e.semanticCode(!1, !0), e.$c.trigger("tbwchange"), setTimeout(function () {
            ...
            dropdown: function (e) {
                ...
                if (o.trigger("mousedown"), l) {
                    ...
                    s.addClass(r + "active"), i.css({
                        ...
                        left: n.o.fixedFullWidth && n.isFixed ? d : d - n.$btnPane.offset().left
                    }).show(), a(t).trigger("scroll"), o.on("mousedown." + n.eventNamespace, function (e) {
            ...
            semanticCode: function (e, t, n) {
                ...
                if (o.saveRange(), o.syncCode(e), o.o.semantic) {
                    if (o.semanticTag("b", o.o.semanticKeepAttributes), o.semanticTag("i", o.o.semanticKeepAttributes), o.semanticTag("s", o.o.semanticKeepAttributes), o.semanticTag("strike", o.o.semanticKeepAttributes), t) {
                        ...
                        s(o.$ed.children(r).first()), o.semanticTag("div", !0), a("[data-tbw]", o.$ed).contents().unwrap(), o.$ed.find("p:empty").remove()
                    }
            ...
            createLink: function () {
                for (var e, t, n, o = this, r = o.doc.getSelection(), i = r.getRangeAt(0), s = r.focusNode, l = (new XMLSerializer).serializeToString(i.cloneContents()) || i + "";
                    ["A", "DIV"].indexOf(s.nodeName) < 0;) s = s.parentNode;
                if (s && "A" === s.nodeName) {
                    var d = a(s);
                    l = d.text(), e = d.attr("href"), o.o.minimalLinks || (t = d.attr("title"), n = d.attr("target"));
            ...
            fullscreen: function () {
                var e, n = this,
                    ...
                    i = r + "-placeholder",
                    s = n.$box.outerHeight();
                n.$box.toggleClass(r), e = n.$box.hasClass(r), e ? n.$box.before(a("<div/>", {
                    "class": i
                }).css({
                    height: s
                })) : a("." + i).remove(), a("body").toggleClass(o + "body-fullscreen", e), a(t).trigger("scroll"), n.$c.trigger("tbw" + (e ? "open" : "close") + "fullscreen")
            },
            ...
            openModal: function (e, n, i) {
                ...
                return e && a("<span/>", {
                    text: e,
                    "class": l + "modal-title"
                }).prependTo(u), i && (a("input:first", u).focus(), s.buildModalBtn("submit", u), s.buildModalBtn("reset", u), d.height(u.outerHeight() + 10)), a(t).trigger("scroll"), d
            },
            ...
            addErrorOnModalField: function (e, t) {
                ...
                e.on("change keyup", function () {
                    r.removeClass(n + "input-error"), setTimeout(function () {
                        r.find("." + o).remove()
                    }, 150)
                }), r.addClass(n + "input-error").find("input+span").append(a("<span/>", {
                    "class": o,
                    text: t
                }))
            },
            ...
            clearButtonPaneStatus: function () {
                var e = this,
                    ...
                    o = t + "original-icon";
                a("." + t + "active-button", e.$btnPane).removeClass(n), a("." + o, e.$btnPane).each(function () {
            ...
            updateButtonPaneStatus: function () {
                ...
                e.clearButtonPaneStatus(), a.each(r, function (r, i) {
                    var s = e.tagToButton[i.toLowerCase()],
                        l = a("." + t + s + "-button", e.$btnPane);
                    if (l.length > 0) l.addClass(n);
                    else try {
                        l = a("." + t + "dropdown ." + t + s + "-dropdown-button", e.$box);
